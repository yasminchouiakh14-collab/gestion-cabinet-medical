    ...
    <style>
        ...
        * { font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .sidebar-brand .brand-icon {
            ...
            font-size: 1.1rem; flex-shrink: 0; font-weight: bold;
        }
        ...
        .avatar {
            ...
            background: #E2E8F0;
            display: flex; align-items: center; justify-content: center;
            color: #475569; font-weight: 600; font-size: .85rem; flex-shrink: 0;
        }
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="mt-2 pb-4">
        ...
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="sidebar-link border-0 w-100 text-start text-danger hover-bg-danger-light">
